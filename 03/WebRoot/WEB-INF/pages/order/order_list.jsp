...
<html>
	...
	<body>
		...
		<div id="box">
			<div id="wdzh_left">
				<div id="left_list">
					<s:a action="cart_list" namespace="/product">我的购物车</s:a>
				</div>
				<div id="left_list">
			...
			<div id="wdzh_right">
				...
				<div id="biaodan">
					<table width="688" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td height="30" bgcolor="#fff8ad">
								<table width="688" height="30" border="0" cellpadding="0"
									cellspacing="0" class="yellow">
									<tr>
										<td width="158" height="30" align="center">
											订单号码
										</td>
						...
						<s:iterator value="pageModel.list">
							<tr>
								<td>
									<div id="xiaotiao">
										<table width="688" height="60" border="0" cellpadding="0"
											cellspacing="0">
											<tr>
												<td width="158" height="30" align="center">
												...
												<td width="112" align="center">
													<p>
														<s:date name="createTime" format="yyyy年MM月d日 HH:mm" />
													</p>
												</td>
												<td width="69" align="center">
